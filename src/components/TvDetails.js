...
import { asyncAddTv, removeTv } from "../store/actions/tvActions";
import {
  Link,
  Outlet,
  useLocation,
...
const TvDetails = () => {
  ...
  return info ? (
    ...
    >
      ...
      <div className="w-full flex">
        ...
        <div className="content ml-[5%]">
          ...
          <div className=" mt-3 mb-3 flex text-white gap-x-5 items-center">
           ...
           {info.detail.runtime &&  <h1>{info.detail.runtime} mins</h1>}
      ...
      <h1 className="text-3xl text-yellow-300 font-semibold">Seasons</h1>
      <div className="w-[100%] flex overflow-y-hidden mb-5 p-5">
        {info.detail.seasons.length > 0 ? (
           info.detail.seasons.map((season, index) => (
            <div className="w-[15vh] mr-[8%]">
              <img
                className="shadow-[8px_17px_40px_2px_rgba(0,0,0,.4)] h-[40vh] min-w-[12vw] object-cover"
              ...
              <h1 className="text-2xl   text-yellow-300 font-semibold">
                {season.name || season.original_title}
              </h1>
            </div>
          ))
        ) : (
      ...
      <h1 className="text-yellow-300 mt-5 mb-3 text-2xl">
